...
- (void)viewDidLoad {
    ...
    self.tableView.nightSeparatorColor = [UIColor whiteColor];//UIColorFromRGB(0x313131);
    ...
    self.navigationController.navigationBar.nightBarTintColor = [UIColor redColor];//UIColorFromRGB(0x444444);
...
- (void)push {
    ...
    SuccViewController *nextVC = [SB instantiateViewControllerWithIdentifier:@"SuccViewController"];
