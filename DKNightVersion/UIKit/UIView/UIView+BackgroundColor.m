...
- (UIColor *)nightBackgroundColor {
    ...
    if (nightColor) {
        if (nightColor.CGColor == [UIColor blackColor].CGColor) {
            NSLog(@"x");
        }
        return nightColor;
    } else {
        BOOL nightOK = [self.nightJoin boolValue];
        UIColor *resultColor = nightOK ? viewBackgroundColor : (self.normalBackgroundColor ? :self.backgroundColor);
        if (resultColor.CGColor == [UIColor blackColor].CGColor) {
            NSLog(@"x");
        }
        return resultColor;
    }
