...
#define viewBackgroundColor [UIColor grayColor]
#define labelTextColor [UIColor lightGrayColor]
#define navBarTintColor [UIColor blackColor]
#define navTintColor [UIColor lightGrayColor]
#define tabBarTintColor [UIColor blackColor]
#define buttonTitleColorN [UIColor lightGrayColor]
#define buttonTitleColorH [UIColor grayColor]
#define buttonTitleColorS [UIColor grayColor]
#define buttonTitleColorD [UIColor clearColor]
#define barButtonItemTintColor [UIColor whiteColor]
#define tableViewSeparatorColor [UIColor whiteColor]
